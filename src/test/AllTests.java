 ...
 */
@RunWith(Suite.class)
@SuiteClasses({ StudentTest.class, StudentDegreeTest.class, StudentEmploymentTest.class, StudentSkillTest.class, DegreeTest.class, SkillTest.class, StudentInternshipTest.class})
