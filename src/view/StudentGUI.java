...
public class StudentGUI extends JPanel implements ActionListener {
	...
	private JPanel createStudentViewPanel(final String theId) {
		...
		JLabel employLabel = new JLabel(" EMPLOYMENTS (" + stuEmployTable.getRowCount() + ")");
	...
	private void performAddStudent() {
		...
		StudentDegree studentDegree = new StudentDegree(uwNetID, degree.getId(), term, year, dblGPA, transfer);
		lblWarning.setText("");
